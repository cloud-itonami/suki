...
| Tests | ✅ **9 tests / 41 assertions, green** — pins G9/G10 RTR, G7 fuel, G8 emissions, G4 witness, N11 no-surveillance, G3 implement, G12 KPI-cap, and repository contracts; `bb -cp src:test run_tests.kotoba` |
